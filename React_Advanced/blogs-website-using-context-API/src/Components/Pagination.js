      ...
      <div className="flex items-center gap-x-3 w-11/12 max-w-2xl mx-auto">
        {page > 1 && (
          ...
          >
            ...
            {/* the above syntax is used if we want to write a particular html code inside the scope of an IF statement if a particular condition satisfies, for example in above case the condition is if page > 1 */}
